...
ROOMS = {
    ...
    # Мои комнаты
    'observatory': {
        'description': 'Круглая комната с куполом из стекла. В центре стоит старинный телескоп. На полу нарисованы звездные карты.',
        'exits': {'south': 'garden'},
        'items': ['telescope', 'star_map', 'crystal_orb'],
        'puzzle': ('На стене висит табличка: "Сколько планет в нашей солнечной системе?" (введите цифру)', '8')
    },
    'underground': {
        'description': 'Темное подземелье с каменными стенами. Воздух холодный и влажный. По углам видны старинные цепи и факелы.',
        'exits': {'south': 'armory', 'east': 'secret_chamber'},
        'items': ['iron_chains', 'old_torch'],
        'puzzle': ('На стене выбито: "Что становится белым в темноте и черным на свету?" (ответ одно слово)', 'звезды')
    }
}